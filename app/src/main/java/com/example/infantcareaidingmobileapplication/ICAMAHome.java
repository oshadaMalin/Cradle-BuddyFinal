...
private Button Logout,infantSig,monthlyPhoto,records,profile;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile=findViewById(R.id.babyprof22);
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),BabayProfile.class));
            }
        });
